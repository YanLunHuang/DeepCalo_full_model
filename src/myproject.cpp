...
void myproject(
	...
	*/
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt3<d_weight13_t, 768,128>(w1_3_new, "w1_3_new.txt");
        nnet::load_weights_from_txt<d_bias13_t, 128>(b1_3, "b1_3.txt");
        nnet::load_weights_from_txt3<d_weight23_t, 16384,128>(w2_3_new, "w2_3_new.txt");
        nnet::load_weights_from_txt<d_bias23_t, 128>(b2_3, "b2_3.txt");
        nnet::load_weights_from_txt3<weight7_t, 16384,128>(w7_new, "w7_new.txt");
        nnet::load_weights_from_txt<bias7_t, 128>(b7, "b7.txt");
        nnet::load_weights_from_txt3<weight11_t, 3840,256>(w11_new, "w11_new.txt");
        nnet::load_weights_from_txt<bias11_t, 256>(b11, "b11.txt");
        nnet::load_weights_from_txt3<weight13_t, 16384,128>(w13_new, "w13_new.txt");
        nnet::load_weights_from_txt<bias13_t, 128>(b13, "b13.txt");
        nnet::load_weights_from_txt3<weight18_t, 196608,512>(w18_new, "w18_new.txt");
        nnet::load_weights_from_txt<bias18_t, 512>(b18, "b18.txt");
        nnet::load_weights_from_txt3<weight22_t, 524288,1024>(w22_new, "w22_new.txt");
        nnet::load_weights_from_txt<bias22_t, 1024>(b22, "b22.txt");
        nnet::load_weights_from_txt3<weight27_t, 1015808,992>(w27_new, "w27_new.txt");
        ...
        nnet::load_weights_from_txt3<weight80_t, 589824,256>(w80_new, "w80_new.txt");
        nnet::load_weights_from_txt<bias80_t, 256>(b80, "b80.txt");
        nnet::load_weights_from_txt3<weight83_t, 65536,256>(w83_new, "w83_new.txt");
	...
	*/
    ...
    nnet::dense_ss_test5<layer4_t, layer7_t, config7>(layer4_out, layer7_out, w7_new, b7); // q_dense_batchnorm_3
	/*
	...
	*/
    ...
    nnet::dense_ss_test5<layer9_t, layer11_t, config11>(layer9_out, layer11_out, w11_new, b11); // q_dense_batchnorm
	/*
	...
	*/
    ...
    nnet::dense_ss_test5<layer10_t, layer13_t, config13>(layer10_out, layer13_out, w13_new, b13); // q_dense_batchnorm_4
	/*
	...
	*/
    ...
    nnet::dense_ss_test5<layer17_t, layer18_t, config18>(layer17_out, layer18_out, w18_new, b18); // q_dense_batchnorm_5
	/*
	...
	*/
    ...
    nnet::dense_ss_test5<layer20_t, layer22_t, config22>(layer20_out, layer22_out, w22_new, b22); // q_dense_batchnorm_6
	/*
	...
	*/
    ...
    nnet::dense_ss_test5<layer25_t, layer27_t, config27>(layer25_out, layer27_out, w27_new, b27); // q_dense
	/*
	...
	*/
    ...
    nnet::dense_ss_test5<layer78_t, layer80_t, config80>(layer78_out, layer80_out, w80_new, b80); // q_dense_batchnorm_7
	/*
	...
	*/
    ...
    nnet::dense_ss_test5<layer82_t, layer83_t, config83>(layer82_out, layer83_out, w83_new, b83); // q_dense_batchnorm_8
	/*
