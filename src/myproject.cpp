...
void myproject(
    hls::stream<input21_t> em_endcap[1], hls::stream<input6_t> scalars[1], hls::stream<input_t> tracks[1],
	...
	*/
    ...
    nnet::linear_single<input21_t, layer24_t, linear_config24>(em_endcap, layer24_out); // quantized_em_endcap
    ...
    nnet::resize_nearest_single<layer24_t, config26>(layer24_out, layer26_out); // up_sampling2d

    hls::stream<layer92_t> layer92_out[1];
    #pragma HLS STREAM variable=layer92_out depth=3540
    nnet::zeropad2d_cl_single<layer26_t, layer92_t, config92>(layer26_out, layer92_out); // zp2d_q_conv2d_batchnorm
	...
	*/
    ...
    nnet::conv_2d_large_cl_nopad_pad_s2s<layer92_t, layer29_t, config29>(layer92_out, layer29_out, w29, b29); // q_conv2d_batchnorm
	/*
	...
	*/
    ...
    nnet::relu_single<layer29_t, layer32_t, relu_config32>(layer29_out, layer32_out); // q_activation_12
    ...
    nnet::film_single<layer32_t, layer33_t, layer34_t, config34>(layer32_out, layer33_out, layer34_out); // fi_lm
	/*
	...
	*/
    ...
    nnet::pooling_single<layer34_t, layer36_t, config36>(layer34_out, layer36_out); // max_pooling2d

    hls::stream<layer93_t> layer93_out[1];
    #pragma HLS STREAM variable=layer93_out depth=870
    nnet::zeropad2d_cl_single<layer36_t, layer93_t, config93>(layer36_out, layer93_out); // zp2d_q_conv2d_batchnorm_1

    hls::stream<layer37_t> layer37_out[1];
    #pragma HLS STREAM variable=layer37_out depth=756
    nnet::conv_2d_large_cl_nopad_pad_s2s<layer93_t, layer37_t, config37>(layer93_out, layer37_out, w37, b37); // q_conv2d_batchnorm_1
	/*
	...
	*/
    ...
    nnet::relu_single<layer37_t, layer40_t, relu_config40>(layer37_out, layer40_out); // q_activation_14
    ...
    nnet::film_single<layer40_t, layer41_t, layer42_t, config42>(layer40_out, layer41_out, layer42_out); // fi_lm_1
	/*
	...
	*/
    hls::stream<layer94_t> layer94_out[1];
    #pragma HLS STREAM variable=layer94_out depth=870
    nnet::zeropad2d_cl_single<layer42_t, layer94_t, config94>(layer42_out, layer94_out); // zp2d_q_conv2d_batchnorm_2

    hls::stream<layer44_t> layer44_out[1];
    #pragma HLS STREAM variable=layer44_out depth=756
    nnet::conv_2d_large_cl_nopad_pad_s2s<layer94_t, layer44_t, config44>(layer94_out, layer44_out, w44, b44); // q_conv2d_batchnorm_2
	/*
	...
	*/
    ...
    nnet::relu_single<layer44_t, layer46_t, relu_config46>(layer44_out, layer46_out); // q_activation_16

    hls::stream<layer47_t> layer47_out[1];
    #pragma HLS STREAM variable=layer47_out depth=182
    nnet::pooling_single<layer46_t, layer47_t, config47>(layer46_out, layer47_out); // max_pooling2d_1

    hls::stream<layer95_t> layer95_out[1];
    #pragma HLS STREAM variable=layer95_out depth=240
    nnet::zeropad2d_cl_single<layer47_t, layer95_t, config95>(layer47_out, layer95_out); // zp2d_q_conv2d_batchnorm_3

    hls::stream<layer48_t> layer48_out[1];
    #pragma HLS STREAM variable=layer48_out depth=182
    nnet::conv_2d_large_cl_nopad_pad_s2s<layer95_t, layer48_t, config48>(layer95_out, layer48_out, w48, b48); // q_conv2d_batchnorm_3
	/*
	...
	*/
    ...
    nnet::relu_single<layer48_t, layer51_t, relu_config51>(layer48_out, layer51_out); // q_activation_17
    ...
    nnet::film_single<layer51_t, layer52_t, layer53_t, config53>(layer51_out, layer52_out, layer53_out); // fi_lm_2
	/*
	...
	*/
    ...
    nnet::zeropad2d_cl_single<layer53_t, layer96_t, config96>(layer53_out, layer96_out); // zp2d_q_conv2d_batchnorm_4

    hls::stream<layer55_t> layer55_out[1];
    #pragma HLS STREAM variable=layer55_out depth=182
    nnet::conv_2d_large_cl_nopad_pad_s2s<layer96_t, layer55_t, config55>(layer96_out, layer55_out, w55, b55); // q_conv2d_batchnorm_4
	/*
	...
	*/
    ...
    nnet::relu_single<layer55_t, layer57_t, relu_config57>(layer55_out, layer57_out); // q_activation_19

    hls::stream<layer58_t> layer58_out[1];
    #pragma HLS STREAM variable=layer58_out depth=42
    nnet::pooling_single<layer57_t, layer58_t, config58>(layer57_out, layer58_out); // max_pooling2d_2

    hls::stream<layer97_t> layer97_out[1];
    #pragma HLS STREAM variable=layer97_out depth=72
    nnet::zeropad2d_cl_single<layer58_t, layer97_t, config97>(layer58_out, layer97_out); // zp2d_q_conv2d_batchnorm_5

    hls::stream<layer59_t> layer59_out[1];
    #pragma HLS STREAM variable=layer59_out depth=42
    nnet::conv_2d_large_cl_nopad_pad_s2s<layer97_t, layer59_t, config59>(layer97_out, layer59_out, w59, b59); // q_conv2d_batchnorm_5
	/*
	...
	*/
    ...
    nnet::relu_single<layer59_t, layer62_t, relu_config62>(layer59_out, layer62_out); // q_activation_20
    ...
    nnet::film_single<layer62_t, layer63_t, layer64_t, config64>(layer62_out, layer63_out, layer64_out); // fi_lm_3
	/*
	...
	*/
    ...
    nnet::zeropad2d_cl_single<layer64_t, layer98_t, config98>(layer64_out, layer98_out); // zp2d_q_conv2d_batchnorm_6

    hls::stream<layer66_t> layer66_out[1];
    #pragma HLS STREAM variable=layer66_out depth=42
    nnet::conv_2d_large_cl_nopad_pad_s2s<layer98_t, layer66_t, config66>(layer98_out, layer66_out, w66, b66); // q_conv2d_batchnorm_6
	/*
	...
	*/
    ...
    nnet::relu_single<layer66_t, layer68_t, relu_config68>(layer66_out, layer68_out); // q_activation_22

    hls::stream<layer69_t> layer69_out[1];
    #pragma HLS STREAM variable=layer69_out depth=9
    nnet::pooling_single<layer68_t, layer69_t, config69>(layer68_out, layer69_out); // max_pooling2d_3

    hls::stream<layer99_t> layer99_out[1];
    #pragma HLS STREAM variable=layer99_out depth=25
    nnet::zeropad2d_cl_single<layer69_t, layer99_t, config99>(layer69_out, layer99_out); // zp2d_q_conv2d_batchnorm_7

    hls::stream<layer70_t> layer70_out[1];
    #pragma HLS STREAM variable=layer70_out depth=9
    nnet::conv_2d_large_cl_nopad_pad_s2s<layer99_t, layer70_t, config70>(layer99_out, layer70_out, w70, b70); // q_conv2d_batchnorm_7
	/*
	...
	*/
    ...
    nnet::relu_single<layer70_t, layer72_t, relu_config72>(layer70_out, layer72_out); // q_activation_23
    ...
    nnet::film_single<layer72_t, layer73_t, layer74_t, config74>(layer72_out, layer73_out, layer74_out); // fi_lm_4
	/*
	...
	*/
    ...
    nnet::zeropad2d_cl_single<layer74_t, layer100_t, config100>(layer74_out, layer100_out); // zp2d_q_conv2d_batchnorm_8

    hls::stream<layer76_t> layer76_out[1];
    #pragma HLS STREAM variable=layer76_out depth=9
    nnet::conv_2d_large_cl_nopad_pad_s2s<layer100_t, layer76_t, config76>(layer100_out, layer76_out, w76, b76); // q_conv2d_batchnorm_8
	/*
	...
	*/
    ...
    nnet::relu_single<layer76_t, layer78_t, relu_config78>(layer76_out, layer78_out); // q_activation_25
	...
	*/
    ...
    nnet::relu_single<layer80_t, layer82_t, relu_config82>(layer80_out, layer82_out); // q_activation_26
	...
	*/
    ...
    nnet::relu_single<layer83_t, layer85_t, relu_config85>(layer83_out, layer85_out); // q_activation_27
