...
void timedistributed_single(
	...
	for (unsigned i = 0; i < CONFIG_T::n_timesteps; i++) {
		...
		#pragma HLS STREAM variable=dense1_res depth=1
		nnet::dense_ss_test5<data_T, res_T, typename CONFIG_T::dense1_config>(data, dense1_res, d_weight1, d_bias1);
		...
		#pragma HLS STREAM variable=dense2_res depth=1
		nnet::dense_ss_test5<res_T, res_T, typename CONFIG_T::dense2_config>(relu1_res, dense2_res, d_weight2, d_bias2);
